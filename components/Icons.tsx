...
export const UserGroupIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.509 0 1.02-.013 1.516-.04M5.25 19.5h13.5m-13.5 0a3 3 0 01-3-3V12a3 3 0 013-3h1.5a3 3 0 013 3v.621m-3.75 6.879a3 3 0 01-3-3V12a3 3 0 013-3h1.5a3 3 0 013 3v.621m-6.75 3.188a3 3 0 00-3-3V12a3 3 0 003-3h1.5a3 3 0 003 3v.621m-3.75 6.879V19.5m0-3.188A3 3 0 0012 12.5a3 3 0 00-3-3h-1.5a3 3 0 00-3 3v.621m0 3.188a3 3 0 013 3h1.5a3 3 0 013-3v-6.379a3 3 0 00-3-3h-1.5a3 3 0 00-3 3v6.379" />
    </svg>
);
...
export const DocumentChartBarIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25A2.25 2.25 0 015.25 3h4.5a2.25 2.25 0 012.25 2.25v.75m-6.75-2.25v.75m0 3v.75m0 3v.75m0 3V15m3-12v.75m0 3v.75m0 3v.75m0 3V15m3-12v.75m0 3v.75m0 3v.75m0 3V15" />
    </svg>
);
...
export const Cog6ToothIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.26.716.53 1.003l.824.824c.42.42.62.99.53 1.558l-.126.862c-.09.613-.58.996-1.19.996h-2.593c-.61 0-1.1-.383-1.19-.996l-.126-.862c-.09-.568.11-1.138.53-1.558l.824-.824c.27-.287.467-.629.53-1.003L9.594 3.94zM15 12a3 3 0 11-6 0 3 3 0 016 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12c0-2.033-1.01-3.86-2.585-4.995l-.126-.862c-.09-.613-.58-.996-1.19-.996h-2.593c-.61 0-1.1.383-1.19.996l-.126.862C9.11 8.14 8.1 9.967 8.1 12c0 2.033 1.01 3.86 2.585 4.995l.126.862c.09.613.58.996 1.19.996h2.593c.61 0 1.1-.383-1.19.996l.126-.862C18.49 15.86 19.5 14.033 19.5 12z" />
    </svg>
);
...
export const ChatBubbleLeftEllipsisIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.388m-5.34-4.437a9.753 9.753 0 01-4.125-7.412A9.75 9.75 0 0112 2.25c4.556 0 8.25 4.03 8.25 9z" />
  </svg>
);

export const CalculatorIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008zm0 3h.008v.008H8.25v-.008zm0 3h.008v.008H8.25v-.008zm3-6h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm3-6h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zM6 6h12v12H6V6z" />
    </svg>
);
...
export const WaImmoLogoIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
      {/* Roof */}
      <path d="M12 2L2 9.33V11h20V9.33L12 2z" />
      {/* Base */}
      <path opacity="0.7" d="M4 12v8h16v-8H4zm6 6H6v-4h4v4zm6 0h-4v-4h4v4z" />
      {/* Wave */}
      <path opacity="0.4" d="M2 19.5c0-1.38 1.12-2.5 2.5-2.5s2.5 1.12 2.5 2.5S5.88 22 4.5 22 2 20.88 2 19.5zm7 0c0-1.38 1.12-2.5 2.5-2.5s2.5 1.12 2.5 2.5S13.38 22 12 22s-2.5-1.12-2.5-2.5zm7 0c0-1.38 1.12-2.5 2.5-2.5s2.5 1.12 2.5 2.5S20.88 22 19.5 22s-2.5-1.12-2.5-2.5z"/>
  </svg>
);
